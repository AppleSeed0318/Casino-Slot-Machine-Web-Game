  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScoreController", ScoreController = (_dec = ccclass('ScoreController'), _dec2 = property({
        ...
        showScore() {
          this.grand.string = cc.gb.user.entireLevel * 1000;
          this.major.string = cc.gb.user.entireLevel * 250;
          this.minor.string = cc.gb.user.entireLevel * 50;
          this.mini.string = cc.gb.user.entireLevel * 10;
        }
...
//# sourceMappingURL=17dd50d5dcf602fdd8262f54a2ff0652c7be0118.js.map