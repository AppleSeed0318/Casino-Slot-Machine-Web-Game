    ...
    execute: function () {
      ...
      _export("ScoreController", ScoreController = (_dec = ccclass('ScoreController'), _dec2 = property({
        ...
        showScore() {
          ...
          this.grand.string = pattern[cc.gb.user.entireLevel] * 1000;
          this.major.string = pattern[cc.gb.user.entireLevel] * 250;
          this.minor.string = pattern[cc.gb.user.entireLevel] * 50;
          this.mini.string = pattern[cc.gb.user.entireLevel] * 10;
        }
...
//# sourceMappingURL=ef57cbd12aeb677a54bd9af382d4892d97ab999c.js.map