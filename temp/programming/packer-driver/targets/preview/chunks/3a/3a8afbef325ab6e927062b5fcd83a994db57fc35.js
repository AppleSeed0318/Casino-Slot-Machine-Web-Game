    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property({
        ...
        onLoad() {
          ...
          var _rateR = 1080.0 / _canvas.designResolution.width;

          var _rateV = cc.winSize.height / cc.winSize.width;

          console.log("winSize: rateR: " + _rateR + " rateV: " + _rateV);
          console.log('screenSize', window.innerHeight, window.innerWidth, _canvas, cc.winSize);
...
//# sourceMappingURL=3a8afbef325ab6e927062b5fcd83a994db57fc35.js.map