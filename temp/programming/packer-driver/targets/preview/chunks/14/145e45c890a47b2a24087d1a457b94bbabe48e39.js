    ...
    execute: function () {
      ...
      _export("SettingDetailController", SettingDetailController = (_dec = ccclass('SettingDetailController'), _dec2 = property({
        ...
        onChangeTotalPlayed(offset) {
          console.log(offset);
          cc.gb.user.totalPlayed -= parseInt(-offset);
          console.log(cc.gb.user.totalPlayed, parseInt(-offset));
          this.showAllValue();
        }

        onChangeEntryLevel(offset) {
          cc.gb.user.entireLevel -= parseInt(-offset);
          this.showAllValue();
        }

        onChangeWays(offset) {
          cc.gb.user.ways -= parseInt(-offset);
          this.showAllValue();
        }

        onChangeCoinValue(offset) {
          cc.gb.user.coinValue -= parseInt(-offset);
          this.showAllValue();
        }
...
//# sourceMappingURL=145e45c890a47b2a24087d1a457b94bbabe48e39.js.map