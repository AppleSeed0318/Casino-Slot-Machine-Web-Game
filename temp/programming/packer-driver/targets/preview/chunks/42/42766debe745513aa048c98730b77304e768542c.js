    ...
    execute: function () {
      ...
      _export("ReelController", ReelController = (_dec = ccclass('ReelController'), _dec(_class = class ReelController extends Component {
        ...
        trunReel() {
          ...
          cc.tween(this.node.children[0]).repeat(10, cc.tween().to(0, {
          ...
          cc.tween(this.node.children[1]).repeat(10, cc.tween().to(0, {
            position: cc.v3(0, 0, 0)
          }).to(1, {
            position: cc.v3(0, -906, 0)
          }).to(0, {
...
//# sourceMappingURL=42766debe745513aa048c98730b77304e768542c.js.map