  ...
  return {
    ...
    execute: function () {
      ...
      _export("SettingDetailController", SettingDetailController = (_dec = ccclass('SettingDetailController'), _dec2 = property({
        ...
        showAllValue() {
          this.totalPlayed.text = '122';
          this.entryLevel.text = '122';
          this.ways.text = '122';
          this.coinValue.text = '122';
        }
        ...
        onChangeTotalPlayed(offset) {
          this.totalPlayed.text = this.totalPlayed.text / 1 + offset;
          console.log('-----', this.totalPlayed.text);
          this.showAllValue();
        }
...
//# sourceMappingURL=03076fc8395911a8ccb272eff42f86e971c16ba7.js.map