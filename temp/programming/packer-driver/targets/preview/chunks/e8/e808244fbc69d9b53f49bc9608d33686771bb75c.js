System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Canvas, settingController, InfoController, SettingDetailController, LogoController, loadingController, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, GameManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property({
        ...
        onLoad() {
          console.log('screenSize', window.innerHeight, window.innerWidth, Canvas, Canvas.instance, cc.winSize);

          var _rateR = 1080.0 / 600;

          var _rateV = window.innerHeight / window.innerWidthh;
...
//# sourceMappingURL=e808244fbc69d9b53f49bc9608d33686771bb75c.js.map