  ...
  return {
    ...
    execute: function () {
      ...
      _export("ReelController", ReelController = (_dec = ccclass('ReelController'), _dec2 = property({
        ...
        start() {
          var posA = new Vec3(0, 0, 0);
          posA = this.node.children[0].position;
          var posB = new Vec3(0, 0, 0);
          posB = this.node.children[1].position;
          console.log(posA, posB);
          this.node.children[0].setPosition(posB);
          console.log(posA, posB);
          this.node.children[1].setPosition(posA);
          console.log(posA, posB);
        }
...
//# sourceMappingURL=59eb8a56e5ad82e4da565cbf88d00f3d6f18f77a.js.map