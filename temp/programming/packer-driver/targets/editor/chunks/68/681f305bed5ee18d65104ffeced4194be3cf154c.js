System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, ReelController, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, ReelManager;
      ...
      _export("ReelManager", ReelManager = (_dec = ccclass('ReelManager'), _dec2 = property({
        ...
        onRunReal() {
          for (var i = 0; i < this.reel.length; i++) {
            ...
            if (round % 2 == 0) this.reel[i].trunReel(round);else this.reel[i].trunReelRev(round);
            cc.log(round);
          }
        }
...
//# sourceMappingURL=681f305bed5ee18d65104ffeced4194be3cf154c.js.map