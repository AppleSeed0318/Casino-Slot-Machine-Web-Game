      ...
      _export("ReelController", ReelController = (_dec = ccclass('ReelController'), _dec2 = property({
        ...
        onLoad() {
          for (var i = 0; i < Math.random() * 100; i++) {
            var a = Math.random() * 100 % this.node.children.length;
            var b = Math.random() * 100 % this.node.children.length;
            console.log(a, this.node.children[a]);
...
//# sourceMappingURL=6a10bbf54487b86a8b379150e983a627ee6dc10a.js.map