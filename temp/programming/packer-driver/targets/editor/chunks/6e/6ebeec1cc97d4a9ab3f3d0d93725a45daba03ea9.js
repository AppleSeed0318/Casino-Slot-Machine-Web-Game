System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, ReelController, AudioManager, SOUND, _dec, _dec2, _class, _class2, _descriptor, _class3, _crd, ccclass, property, ReelManager;
  ...
  function _reportPossibleCrUseOfSOUND(extras) {
    _reporterNs.report("SOUND", "./Global/constants", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("ReelManager", ReelManager = (_dec = ccclass('ReelManager'), _dec2 = property({
        ...
        onRunReal() {
          ...
          console.log((_crd && SOUND === void 0 ? (_reportPossibleCrUseOfSOUND({
            error: Error()
          }), SOUND) : SOUND).REAL_START, (_crd && SOUND === void 0 ? (_reportPossibleCrUseOfSOUND({
            error: Error()
          }), SOUND) : SOUND).ROLLING_START, '-------------');
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.playReel();
...
//# sourceMappingURL=6ebeec1cc97d4a9ab3f3d0d93725a45daba03ea9.js.map