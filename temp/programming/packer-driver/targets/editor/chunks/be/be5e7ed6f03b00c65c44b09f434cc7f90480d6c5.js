  ...
  return {
    ...
    execute: function () {
      ...
      _export("SettingDetailController", SettingDetailController = (_dec = ccclass('SettingDetailController'), _dec2 = property({
        ...
        showAllValue() {
          this.totalPlayed.string = '122';
          this.entryLevel.string = '122';
          this.ways.string = '122';
          this.coinValue.string = '122';
        }
        ...
        onChangeTotalPlayed(offset) {
          this.totalPlayed.string = this.totalPlayed.string / 1 + offset;
          console.log('-----', this.totalPlayed.string);
          this.showAllValue();
        }
...
//# sourceMappingURL=be5e7ed6f03b00c65c44b09f434cc7f90480d6c5.js.map