System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, AudioSource, AudioClip, ReelController, AudioManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, ReelManager;
    ...
    execute: function () {
      ...
      _export("ReelManager", ReelManager = (_dec = ccclass('ReelManager'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "reelSound", _descriptor2, this);
        }
        ...
        onRunReal() {
          ...
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.init(this.node.getComponent(AudioSource));
          console.log((_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance);
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.playSound(this.reelSound);
          console.log((_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance);
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "reelSound", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=4c15673dc21300a9dd6ecfaf10ef79203d0fe730.js.map